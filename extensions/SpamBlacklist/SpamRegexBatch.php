...
class SpamRegexBatch
{
     ...
     * @return array
     */
    public static function buildRegexes($lines, BaseBlacklist $blacklist, $batchSize=4096)
    {
        # Make regex
     ...
     */
    public static function validateRegexes($regexes)
    {
     ...
     * @return array
     */
    public static function stripLines($lines)
    {
        return array_filter(
            array_map(
                'trim',
     ...
     */
    public static function buildSafeRegexes($lines, BaseBlacklist $blacklist, $fileName=false)
    {
