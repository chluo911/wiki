...
$trace = debug_backtrace();
    ...
    protected function showForm($action)
    {
        ...
        if ($action === 'add' || $action === 'edit') {
            $formContent = Html::rawElement(
                ...
                Html::rawElement(
                    'td',
                    $input,
                    Xml::check('wpInterwikiTrans', $trans, [ 'id' => 'mw-interwiki-trans' ])
                )
            ) . Html::rawElement(
                'tr',
                null,
        ...
        $form = Xml::fieldset($topmessage, Html::rawElement(
            ...
            Html::rawElement(
                'table',
                [ 'id' => "mw-interwiki-{$action}" ],
                $formContent . Html::rawElement(
                    'tr',
                    null,
                    Html::rawElement('td', $label, Xml::label(
                        $this->msg('interwiki_reasonfield')->text(),
