...
class GenerateSitemap extends Maintenance
{
     ...
     * @return string
     */
    public function priority($namespace)
    {
     ...
     * @return string
     */
    public function guessPriority($namespace)
    {
     ...
     * @return Resource
     */
    public function getPageRes($namespace)
    {
     ...
     * @return resource
     */
    public function open($file, $flags)
    {
     ...
     * @return string
     */
    public function sitemapFilename($namespace, $count)
    {
     ...
     * @return string
     */
    public function indexEntry($filename)
    {
        return
            "\t<sitemap>\n" .
     ...
     * @return string
     */
    public function fileEntry($url, $date, $priority)
    {
        return
            "\t<url>\n" .
     ...
     * @param int $namespace
     */
    public function generateLimit($namespace)
    {
