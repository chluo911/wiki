...
TEXT
    ...
    public function processFileOpt($opt)
    {
        $split = explode(':', $opt, 2);
        $val = $split[0];
        $param = '';
    ...
    public function setTimeExceeded()
    {
        $this->timeExceeded = true;
    }

    public function checkIfTimeExceeded()
    {
    ...
    public function finalOptionCheck()
    {
     ...
     * @return bool
     */
    public function readDump($input)
    {
        $this->buffer = "";
     ...
     */
    public function getText($id, $model = null, $format = null)
    {
...
$trace = debug_backtrace();
    ...
    public function clearOpenElement($style)
    {
$trace = debug_backtrace();
	  error_log(__FILE__);
	  var_dump(__FUNCTION__);
