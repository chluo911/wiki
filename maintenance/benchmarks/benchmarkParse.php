...
class BenchmarkParse extends Maintenance
{
     ...
     */
    public function getRevIdForTime(Title $title, $timestamp)
    {
     ...
     */
    public function runParser(Revision $revision)
    {
     ...
     * @return bool
     */
    public function onFetchTemplate(Parser $parser, Title $title, &$skip, &$id)
    {
