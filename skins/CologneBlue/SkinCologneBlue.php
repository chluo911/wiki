...
class CologneBlueTemplate extends BaseTemplate
{
    ...
    public function pageTitleLinks()
    {
        $s = array();
     ...
     * @return string
     */
    public function processBottomLink($key, $navlink, $message = null)
    {
        if (!$navlink) {
     ...
     */
    public function processNavlinkForDocument($navlink, $idPrefix = 'cb-')
    {
        if ($navlink['id']) {
    ...
    public function beforeContent()
    {
        ...
        $this->text('pageLanguage'); ?>"><?php echo $this->data['title'] ?></h1>
		<?php
     ...
     */
    public function sidebarAdditions($bar)
    {
     ...
     * @return string
     */
    public function searchForm($which)
    {
