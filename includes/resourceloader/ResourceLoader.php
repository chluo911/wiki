...
$trace = debug_backtrace();
     ...
     */
    public function makeModuleResponse(
        ResourceLoaderContext $context,
        array $modules,
        array $missing = []
    ) {
...
$trace = debug_backtrace();
     ...
     * @return string
     */
    public static function makeCustomLoaderScript(
        $name,
        $version,
        $dependencies,
        $group,
...
$trace = debug_backtrace();
    ...
    public static function inDebugMode()
    {
        if (self::$debugMode === null) {
            ...
            self::$debugMode = $wgRequest->getFuzzyBool(
                'debug',
     ...
     */
    public function createLoaderURL(
        $source,
        ResourceLoaderContext $context,
        $extraQuery = []
    ) {
     ...
     * @return array
     */
    public static function makeLoaderQuery(
        $modules,
        $lang,
        $skin,
        $user = null,
