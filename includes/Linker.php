...
class Linker
{
     ...
     * @return string
     */
    public static function getInterwikiLinkAttributes($title, $unused = null, $class = 'external')
    {
$trace = debug_backtrace();
     ...
     * @return string
     */
    public static function getInternalLinkAttributes($title, $unused = null, $class = '')
    {
$trace = debug_backtrace();
	  error_log(__FILE__);
	  var_dump(__FUNCTION__);
     ...
     * @return string
     */
    public static function getInternalLinkAttributesObj($nt, $unused = null, $class = '', $title = false)
    {
$trace = debug_backtrace();
	  error_log(__FILE__);
	  var_dump(__FUNCTION__);
...
$trace = debug_backtrace();
     ...
     * @return string
     */
    public static function makeExternalLink(
        $url,
        $text,
        $escape = true,
        $linktype = '',
     ...
     */
    public static function formatTemplates(
        $templates,
        $preview = false,
        $section = false,
        $more = null
