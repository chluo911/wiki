...
class ZipDirectoryReader
{
     ...
     */
    public function error($code, $debugMessage)
    {
     ...
     * spec.
     */
    public function readEndOfCentralDirectoryRecord()
    {
        $info = [
            'signature' => 4,
            'disk' => 2,
     ...
     */
    public function readZip64EndOfCentralDirectoryLocator()
    {
        $info = [
            'signature' => [ 'string', 4 ],
     ...
     */
    public function readZip64EndOfCentralDirectoryRecord()
    {
     ...
     */
    public function findOldCentralDirectory()
    {
     ...
     * @return array List containing offset, size and end position.
     */
    public function findZip64CentralDirectory()
    {
     ...
     * @param int $size
     */
    public function readCentralDirectory($offset, $size)
    {
     ...
     * @return array|bool
     */
    public function unpackZip64Extra($extraField)
    {
        $extraHeaderInfo = [
            'id' => 2,
            'size' => 2,
     ...
     * @return string
     */
    public function getBlock($start, $length = null)
    {
     ...
     * @return string
     */
    public function getSegment($segIndex)
    {
     ...
     * @return int
     */
    public function getStructSize($struct)
    {
        $size = 0;
     ...
     */
    public function unpack($string, $struct, $offset = 0)
    {
     ...
     * @return bool
     */
    public function testBit($value, $bitIndex)
    {
