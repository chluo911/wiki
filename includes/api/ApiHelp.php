...
class ApiHelp extends ApiBase
{
     ...
     * @return string
     */
    private static function getHelpInternal(
        ...
        foreach ($modules as $module) {
            ...
            if ($urls) {
                $help['help-urls'] .= Html::openElement(
                    'div',
                ...
                foreach ($urls as $url) {
                    $help['help-urls'] .= Html::rawElement(
                        'li',
                        null,
            ...
            if ($params || $dynamicParams !== null) {
                $help['parameters'] .= Html::openElement(
                    'div',
                ...
                foreach ($params as $name => $settings) {
                    ...
                    $help['parameters'] .= Html::rawElement(
                        'dt',
                        null,
