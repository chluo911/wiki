...
{
    private $fld_protection = false;
    private $fld_talkid = false;
    private $fld_subjectid = false;
    private $fld_url = false;
    private $fld_readable = false;
    private $fld_watched = false;
    private $fld_watchers = false;
    private $fld_visitingwatchers = false;
    private $fld_notificationtimestamp = false;
    private $fld_preload = false;
    private $fld_displaytitle = false;
