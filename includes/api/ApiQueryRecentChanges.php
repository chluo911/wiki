...
class ApiQueryRecentChanges extends ApiQueryGeneratorBase
{
    ...
    private $fld_comment = false;
    private $fld_parsedcomment = false;
    private $fld_user = false;
    private $fld_userid = false;
    private $fld_flags = false;
    private $fld_timestamp = false;
    private $fld_title = false;
    private $fld_ids = false;
    private $fld_sizes = false;
    private $fld_redirect = false;
    private $fld_patrolled = false;
    private $fld_loginfo = false;
    private $fld_tags = false;
    private $fld_sha1 = false;
    private $token = [];
