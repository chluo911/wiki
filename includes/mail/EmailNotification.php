...
$trace = debug_backtrace();
     ...
     * @param string $source
     */
    public function compose($user, $source)
    {
     ...
     * @private
     */
    public function sendPersonalised($watchingUser, $source)
    {
     ...
     * @return Status|null
     */
    public function sendImpersonal($addresses)
    {
        global $wgContLang;
