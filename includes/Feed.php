...
class FeedItem
{
     ...
     */
    public function __construct($title, $description, $url, $date = '', $author = '', $comments = '')
    {
        $this->title = $title;
...
class RSSFeed extends ChannelFeed
{
    ...
    public function outHeader()
    {
        ...
        $this->outXmlHeader(); ?><rss version="2.0" xmlns:dc="http://purl.org/dc/elements/1.1/">
	<channel>
...
<?php
    ...
    ?>
		<item>
			...
			<guid<?php if (!$item->rssIsPermalink) {
