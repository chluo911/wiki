            ...
            if ($this->displayImg->allowInlineDisplay()) {
                ...
                if ($width > $maxWidth || $height > $maxHeight || $this->displayImg->isVectorized()) {
                    ...
                    foreach ($thumbSizes as $size) {
                        ...
                        if ((
                            ($size[0] <= $width_orig && $size[1] <= $height_orig)
...
EOT
    ...
    protected function imageDupes()
    {
        ...
        $out->addWikiMsg(
            'duplicatesoffile',
            $this->getContext()->getLanguage()->formatNum(count($dupes)),
...
$trace = debug_backtrace();
    ...
    protected function doRenderLangOpt(array $langChoices, $curLang, $defaultLang)
    {
        ...
        $langSelectLine = Html::rawElement(
            'div',
            [ 'id' => 'mw-imglangselector-line' ],
