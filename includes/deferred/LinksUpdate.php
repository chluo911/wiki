...
class LinksUpdate extends DataUpdate implements EnqueueableDataUpdate
{
     ...
     * @param array $cats
     */
    public function invalidateCategories($cats)
    {
     ...
     * @param array $images
     */
    public function invalidateImageDescriptions($images)
    {
     ...
     * @return array
     */
    public function getPropertyInsertions($existing = [])
    {
     ...
     * @return array
     */
    public function getPropertyDeletions($existing)
    {
