...
class DatabaseSqlite extends Database
{
     ...
     * @return PDO
     */
    public function open($server, $user, $pass, $dbName)
    {
        $this->close();
...
$trace = debug_backtrace();
     ...
     * @return array
     */
    public static function fixIgnore($options)
    {
     ...
     * @return string
     */
    public function makeInsertOptions($options)
    {
        $options = self::fixIgnore($options);
...
$trace = debug_backtrace();
     ...
     */
    public function duplicateTableStructure($oldName, $newName, $temporary = false, $fname = __METHOD__)
    {
