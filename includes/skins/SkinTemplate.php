...
$trace = debug_backtrace();
     ...
     * @private
     */
    public function printOrError($str)
    {
        echo $str;
    }
     ...
     * @return bool
     */
    public function useCombinedLoginLink()
    {
    ...
    public function makeTalkUrlDetails($name, $urlaction = '')
    {
            ...
            if ($userCanRead) {
                ...
                if ($title->quickUserCan('edit', $user)
                    ...
                    $content_navigation['views']['edit'] = [
                        'class' => (
                            $isEditing && ($section !== 'new' || !$showNewSection)
                            ? 'selected'
                            : ''
                        ) . $isTalkClass,
