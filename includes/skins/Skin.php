...
abstract class Skin extends ContextSource
{
     ...
     * @return string[]
     */
    public static function getSkinNameMessages()
    {
$trace = debug_backtrace();
     ...
     * @param OutputPage $out
     */
    abstract public function outputPage(OutputPage $out = null);
     ...
     * @todo delete
     */
    abstract public function setupSkinUserCss(OutputPage $out);
     ...
     */
    public function drawCategoryBrowser($tree)
    {
        $return = '';
     ...
     */
    public function showIPinHeader()
    {
$trace = debug_backtrace();
	  error_log(__FILE__);
	  var_dump(__FUNCTION__);
     ...
     * @return string
     */
    public function escapeSearchLink()
    {
...
$trace = debug_backtrace();
     ...
     * @return array
     */
    public static function makeUrlDetails($name, $urlaction = '')
    {
        $title = Title::newFromText($name);
        self::checkTitle($title, $name);
     ...
     * @return array
     */
    public static function makeKnownUrlDetails($name, $urlaction = '')
    {
        $title = Title::newFromText($name);
        self::checkTitle($title, $name);
