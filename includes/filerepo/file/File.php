...
$trace = debug_backtrace();
     ...
     * @return string
     */
    public function getTransformScript()
    {
...
$trace = debug_backtrace();
     ...
     */
    public function migrateThumbFile($thumbName)
    {
    }
...
$trace = debug_backtrace();
     ...
     * @return string
     */
    public function getArchiveThumbRel($archiveName, $suffix = false)
    {
...
$trace = debug_backtrace();
     ...
     * @return string Path
     */
    public function getZoneUrl($zone, $suffix = false)
    {
        $this->assertRepoDefined();
        $ext = $this->getExtension();
...
$trace = debug_backtrace();
     ...
     * @return Title|null
     */
    public function getRedirectedTitle()
    {
        if ($this->redirected) {
