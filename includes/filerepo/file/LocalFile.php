...
$trace = debug_backtrace();
     ...
     * @return array
     */
    public function getLazyCacheFields($prefix = 'img_')
    {
     ...
     * @return array
     */
    public function decodeRow($row, $prefix = 'img_')
    {
...
$trace = debug_backtrace();
     ...
     */
    public function getThumbnails($archiveName = false)
    {
        if ($archiveName) {
     ...
     */
    public function purgeMetadataCache()
    {
        $this->invalidateCache();
    }
...
$trace = debug_backtrace();
     ...
     *     archive name, or an empty string if it was a new file.
     */
    public function publishTo($src, $dstRel, $flags = 0, array $options = [])
    {
        $srcPath = ($src instanceof FSFile) ? $src->getPath() : $src;
