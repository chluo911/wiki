...
$trace = debug_backtrace();
     ...
     */
    public function fetchRevisions($limit, $offset, $direction)
    {
...
class HistoryPager extends ReverseChronologicalPager
{
     ...
     * @param array $conds
     */
    public function __construct($historyPage, $year = '', $month = '', $tagFilter = '', $conds = [])
    {
...
$trace = debug_backtrace();
    ...
    public function getStartBody()
    {
        ...
        $this->buttons .= $this->submitButton(
            $this->msg('compareselectedversions')->text(),
            $attrs
        ) . "\n";
     ...
     */
    public function submitButton($message, $attributes = [])
    {
     ...
     * @return string
     */
    public function curLink($rev, $latest)
    {
     ...
     * @return string
     */
    public function lastLink($prevRev, $next)
    {
     ...
     */
    public function diffButtons($rev, $firstInList)
    {
        if ($this->getNumRows() > 1) {
            $id = $rev->getId();
