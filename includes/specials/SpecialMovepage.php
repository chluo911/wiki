...
$trace = debug_backtrace();
    ...
    public function showForm($err)
    {
        ...
        $out->addWikiMsg(
            $this->getConfig()->get('FixDoubleRedirects') ?
            'movepagetext' :
    ...
    public function doSubmit()
    {
        ...
        $out->addHTML($this->msg('movepage-moved')->rawParams(
            $oldLink,
            $newLink
        )->params($oldText, $newText)->parseAsBlock());
     ...
     */
    public function showSubpages($title)
    {
    ...
    public function showSubpagesList($subpages, $pagecount, $wikiMsg, $noSubpageMsg = false)
    {
        $out = $this->getOutput();
