...
class SpecialRecentChanges extends ChangesListSpecialPage
{
    ...
    protected function categoryFilterForm(FormOptions $opts)
    {
        ...
        $input .= ' ' . Xml::checkLabel(
            $this->msg('rc_categories_any')->text(),
            'categories_any',
            'mw-categories_any',
            $opts['categories_any']
        );
     ...
     * @param FormOptions $opts
     */
    public function filterByCategories(&$rows, FormOptions $opts)
    {
     ...
     * @return string
     */
    public function makeOptionsLink($title, $override, $options, $active = false)
    {
     ...
     * @return string
     */
    public function optionsPanel($defaults, $nondefaults, $numRows)
    {
