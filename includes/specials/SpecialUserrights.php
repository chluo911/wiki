...
class UserrightsPage extends SpecialPage
{
     ...
     * @return null
     */
    public function saveUserGroups($username, $reason, $user)
    {
     ...
     * @param array $reason
     */
    public function addLogEntry($user, $oldGroups, $newGroups, $reason)
    {
     ...
     */
    public function editUserGroupsForm($username)
    {
        ...
        $this->getOutput()->addHTML(
            ...
            Xml::openElement('table', [ 'id' => 'mw-userrights-table-outer' ]) .
				...
				<tr>
					...
					<td class='mw-submit'>" .
                        Xml::submitButton(
                            $this->msg('saveusergroups', $user->getName())->text(),
                            [ 'name' => 'saveusergroups' ] +
    ...
    private function canRemove($group)
    {
        ...
        return in_array(
            ...
            $groups['remove']
                ...
                $this->isself && in_array($group, $groups['remove-self'])
            );
    }
    ...
    private function canAdd($group)
    {
        ...
        return in_array(
            ...
            $groups['add']
                ...
                $this->isself && in_array($group, $groups['add-self'])
            );
    }
