...
class SpecialTags extends SpecialPage
{
    ...
    public function showTagList()
    {
        ...
        $html = Xml::tags(
            'tr',
            null,
            Xml::tags('th', null, $this->msg('tags-tag')->parse()) .
    ...
    public function doTagRow($tag, $hitcount, $showManageActions, $showDeleteActions, $showEditLinks)
    {
        $newRow = '';
...
$trace = debug_backtrace();
    ...
    protected function showDeleteTagForm($tag)
    {
        ...
        if (isset($tagUsage[$tag]) && $tagUsage[$tag] > 0) {
            $preText .= $this->msg(
                'tags-delete-explanation-in-use',
                $tag,
                $tagUsage[$tag]
            )->parseAsBlock();
        }
