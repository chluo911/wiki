...
class AllMessagesTablePager extends TablePager
{
    ...
    public function __construct($page, $conds, $langObj = null)
    {
    ...
    public function buildForm()
    {
        ...
        $out = Xml::openElement('form', [
            ...
            "</td>\n
				<td class='mw-input'>" .
            Xml::radioLabel(
                $this->msg('allmessages-filter-unmodified')->text(),
                'filter',
                'unmodified',
            ...
            Xml::radioLabel(
                $this->msg('allmessages-filter-all')->text(),
                'filter',
                'all',
            ...
            Xml::radioLabel(
                $this->msg('allmessages-filter-modified')->text(),
                'filter',
                'modified',
    ...
    public function getAllMessages($descending)
    {
    ...
    public function getRowAttrs($row, $isSecond = false)
    {
        $arr = [];
    ...
    public function isFieldSortable($x)
    {
        return false;
    }
