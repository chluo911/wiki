...
class ChangeTags
{
     ...
     * @since 1.25
     */
    protected static function updateTagSummaryRow(
        &$tagsToAdd,
        &$tagsToRemove,
        $rc_id,
        $rev_id,
        ...
        if ($tagsToAdd) {
            ...
            if ($diff) {
                return self::restrictedTagError(
                    ...
                    'tags-update-add-not-allowed-multi',
                    $diff
                );
            }
        }
     ...
     * @since 1.25
     */
    public static function updateTagsWithChecks(
        $tagsToAdd,
        $tagsToRemove,
        $rc_id,
        $rev_id,
    ...
    )
    {
        ...
        // do it!
        list($tagsAdded, $tagsRemoved, $initialTags) = self::updateTags(
            $tagsToAdd,
            $tagsToRemove,
            $rc_id,
            $rev_id,
     ...
     */
    public static function modifyDisplayQuery(
        &$tables,
        &$fields,
        &$conds,
        &$join_conds,
     ...
     * @since 1.25
     */
    protected static function logTagManagementAction(
        $action,
        $tag,
        $reason,
        User $user,
     ...
     * @since 1.25
     */
    public static function activateTagWithChecks(
        $tag,
        $reason,
        User $user,
     ...
     * @since 1.25
     */
    public static function deactivateTagWithChecks(
        $tag,
        $reason,
        User $user,
        $ignoreWarnings = false
     ...
     * @since 1.25
     */
    public static function createTagWithChecks(
        $tag,
        $reason,
        User $user,
        $ignoreWarnings = false
     ...
     * @since 1.25
     */
    public static function deleteTagWithChecks(
        $tag,
        $reason,
        User $user,
        $ignoreWarnings = false
