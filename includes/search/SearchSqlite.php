...
class SearchSqlite extends SearchDatabase
{
     ...
     * @return bool
     */
    public function fulltextSearchSupported()
    {
     ...
     * @return string
     */
    public function queryNamespaces()
    {
     ...
     * @return string
     */
    public function limitResult($sql)
    {
     ...
     * @return string
     */
    public function getQuery($filteredTerm, $fulltext)
    {
     ...
     * @return string
     */
    public function queryMain($filteredTerm, $fulltext)
    {
    ...
    public function getCountQuery($filteredTerm, $fulltext)
    {
        $match = $this->parseQuery($filteredTerm, $fulltext);
        $page = $this->db->tableName('page');
        $searchindex = $this->db->tableName('searchindex');
