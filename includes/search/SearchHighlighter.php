...
class SearchHighlighter
{
     ...
     * @param string $text
     */
    public function splitAndAdd(&$extracts, &$count, $text)
    {
     ...
     * @return string
     */
    public function caseCallback($matches)
    {
$trace = debug_backtrace();
     ...
     * @return string
     */
    public function extract($text, $start, $end, &$posStart = null, &$posEnd = null)
    {
        if ($start != 0) {
     ...
     */
    public function position($text, $point, $offset = 0)
    {
        $tolerance = 10;
     ...
     * @protected
     */
    public function process($pattern, $extracts, &$linesleft, &$contextchars, &$out, &$offsets)
    {
        if ($linesleft == 0) {
     ...
     * @return mixed
     */
    public function removeWiki($text)
    {
     ...
     * @return string
     */
    public function linkReplace($matches)
    {
$trace = debug_backtrace();
	  error_log(__FILE__);
	  var_dump(__FUNCTION__);
